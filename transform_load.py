...
POSTGRES_DSN = os.getenv('POSTGRES_URI', 'postgresql://postgres:Cheikh12@localhost/postgres')
...
def transform_and_load():
    ...
    for doc in docs:
        ...
        INSERT INTO weather_readings (
            ...
            visibility_m, rain_1h_mm, snow_1h_mm, condition_main, condition_description, ingested_at
        ) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)
        ON CONFLICT (city, observed_at) DO UPDATE SET
            temp_c=EXCLUDED.temp_c, rain_1h_mm=EXCLUDED.rain_1h_mm, ingested_at=EXCLUDED.ingested_at;
        '''
